              ...
              <div className="detail-container">
                ...
                <div className="detail-info">
                  <p className="detail-name">
                    Nom : {friend.user_id === null ? "BUGGY" : friend.name}
                  </p>
                  <p className="detail-role">
                    Race :{" "}
                    {friend.user_id === null
                      ? "BUGGY"
                      : friend.race.toUpperCase()}
                  </p>
                </div>
                <div className="detail-score">
                  <p className="score">Score : {friend.points}</p>
                  <p className="ratio">Victoires : {friend.victories}</p>
                  <p className="ratio">
                    Ratio :{" "}
                    {(friend.victories / friend.defeats || 0).toFixed(2)}
                  </p>
                </div>
                <div className="detail-action">
                  ...
                  <button onClick={deleteToFriend} className="btn secondary">
                    Supprimer des amis
                  </button>
                </div>
              </div>
