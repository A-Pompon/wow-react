                ...
                <div className="profil-card">
                  <div className="img-info">
                    ...
                    <div className="profil-info">
                      <div className="profil-row">
                        <p className="profil-name">Nom : {user.User.name}</p>
                      </div>
                      <button onClick={goUpdateName} className="btn primary">
                        Modifier
                      </button>
                      <div className="profil-row">
                        <p className="profil-role">Race : {user.User.race}</p>
                      </div>
                      <button onClick={goUpdateRace} className="btn primary">
                        Modifier
                      </button>
                    </div>
                  </div>
                  <div className="profil-score">
                    <div className="info-score">
                      ...
                      <p className="loose">Défaites : {user.defeats}</p>
                      {!(user.victories / user.defeats) ? (
                        <p>Ratio : 0</p>
                      ) : (
                        <p className="ratio">
                          Ratio : {(user.victories / user.defeats).toFixed(2)}
                        </p>
                      )}
                    </div>
                  ...
                  <div className="profil-action">
                    <button className="btn-game" onClick={goGame}>
                      Jouer
                    </button>
