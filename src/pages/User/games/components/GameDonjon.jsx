...
const GameDonjon = () => {
  ...
  const playingCondition = () => {
    ...
    if (
      (player === "Lance" && iaPlayer === "Bouclier") ||
      ...
      {isLoading ? (
        ...
        <div className="donjon-container">
          <div className="game-board-container">
            <p className="score-reach">
              Nombre de PVs de l'adversaire : {scoreToReach}
            </p>
            <div className="opponent-card">
              <div className="opponent-img">
                <img
                  className="img-card"
                  src={getImageOpponent(opponentImg.toLowerCase())}
                  alt="Opponent"
                />
              </div>
              <div className="opponent-info">
                <h4 className="opponent-name">{opponent}</h4>
                ...
                <div className="progress-bar">
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor:
                        scorePlayer === scoreToReach - 1 ? "red" : "green",
                    }}
                  ></div>
                </div>
              </div>
            ...
            <div className="fight-card">
              <div
                style={{ display: !iaPlayer ? "flex" : "none" }}
                className="pre-fight"
              >
                <h4 className="fight-img">{opponent}</h4>
                <p className="fight-para">VS</p>
                <h4 className="fight-img">{userConnected.user_id.name}</h4>
              </div>
              ...
              >
                <div className="fight-img">
                  <img
                    className="img-fight"
                    src={getImageSigne(player.toLowerCase())}
                ...
                <div className="fight-img">
                  <img
                    className="img-fight"
                    src={getImageSigne(iaPlayer.toLowerCase())}
                    alt={`${opponent} choice`}
                  />
                </div>
              </div>
              ...
              <div
                style={{ display: iaPlayer && player ? "flex" : "none" }}
                className="resultat"
              >
                <h4 className="affichage">{resultat}</h4>
              </div>
            </div>

            <div className="profil-card-donjon">
              <div className="profil-info-donjon">
                <h4 className="profil-name">{userConnected.user_id.name}</h4>
                <p className="profil-pv">PVs : {5 - scoreIa}/5</p>
                <div className="progress-bar">
                  <div
                    className="progress-bar-fill"
                    style={{
              ...
              <div className="profil-img">
                <img
                  className="img-card"
                  src={getImageRace(userConnected.User.race.toLowerCase())}
                  alt="Race"
                />
              </div>
            </div>
